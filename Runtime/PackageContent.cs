...
using System.Xml.Serialization;
    ...
    public abstract class PackageContent
    {
        ...
        public static Queue<PackageContent> dirtyPackageContents;
        ...
        [XmlIgnore]
        public virtual string FilePath { get { return EnginePathVariables.FilePath(this); } }
        public virtual string FolderPath { get { return EnginePathVariables.FolderPath(this); } }
        ...
        {
            if (!isDirty)
                dirtyPackageContents.Enqueue(this);
            isDirty = true;
        }
